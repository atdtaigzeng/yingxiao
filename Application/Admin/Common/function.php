...
function getAllMenu(){
	return	array(
			...
			'promotion' => array('name' => '促销管理', 'icon'=>'fa-bell', 'sub_menu' => array(
			        ...
			        array('name' => '学车券管理','act'=>'coupon_car', 'control'=>'Coupon'),
			        array('name' => '奖品管理','act'=>'prize', 'control'=>'Coupon'),
			        array('name' => '抽奖队列','act'=>'prize_line', 'control'=>'Coupon'),
                    array('name' => '代金券列表','act'=>'list_coupon','control'=>'Coupon'),
			)),
