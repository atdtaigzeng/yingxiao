...
class IndexController extends MobileBaseController {
    ...
    public function index(){                
        ...
        */
        ...
        /* if( $user_id = I('get.user_id') ){
            //将user_id存入cookie中
            cookie('first_leader',$user_id,3600);
        } */
        $article = M('article')->where(1)->order("article_id desc")->field("article_id,title,link")->limit(5)->select();
        $this->assign('lists',$article);
    ...
    public function article(){
        ...
        if($article){
            ...
            $this->assign('cat_name',$parent['cat_name']);//分类名
