                    ...
                    <div class="box  box-success">
				        <div class="box-body">
				        	<div class="info-box">
					         	<table class="table table-bordered">
					         		<tr>
					         			<td>程序版本：</td><td>shop <?php echo ($sys_info["version"]); ?></td>
					         			<td>更新时间：</td><td>2017-04-01</td>
					         			<td>程序开发：</td><td>坤达信息科技有限公司</td>			         			
					         		</tr>
					         		<tr>
					         			<td>版权所有：</td><td>坤达信息科技有限公司</td>
					         			<td>官方授权：</td><td><a href="#" target="_blank">商业授权</a></td>
