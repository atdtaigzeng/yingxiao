        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i>抽奖排队用户(总人数<?php echo ($totle); ?>)</h3>
                </div>
                ...
                <div class="panel-body">
	                <div class="navbar navbar-default">
	                	<form class="navbar-form form-inline" action="" method="post">
                            ...
                            <div class="form-group ">
                                <a href="<?php echo U('Coupon/tree');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>查看队列树</a>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center"><?php echo ($list["first"]); ?></td>
                                        <td class="text-center"><?php echo ($list["second"]); ?></td>
                                        <td class="text-center"><?php echo ($list["third"]); ?></td>
                                        <td class="text-center"><?php echo (date('Y-m-d H:i:s',$list["addtime"])); ?></td>
                                        <td class="text-center"><img src="<?php echo ($list["head_pic"]); ?>" width="50px" height="50px"/></td>
                                        <td class="text-center">
