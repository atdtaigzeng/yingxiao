...
<html>
  <head>
    ...
    <!-- 系统升级js文件 <script src="/Public/js/upgrade.js"></script> -->
...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index.php/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="/Public/images/TP-shop_logo.png" width="40" height="30">&nbsp;&nbsp;<b>管理后台</b></span>
      </a>
...
<aside class="main-sidebar" style="overflow-y:auto;">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu"> 
          ...
          <li><a href="#" target="_blank"><i class="fa fa-circle-o text-red"></i> <span>使用手册</span></a></li>
          <li><a href="#" target="_blank"><i class="fa fa-circle-o text-yellow"></i> <span>视频教程</span></a></li>
          <li><a href="#" target="_blank"><i class="fa fa-circle-o text-aqua"></i> <span>ThinkPHP手册</span></a></li> -->
        </ul>
      </section>
</aside>
...
<section class="content-wrapper right-side" id="riframe" style="margin:0px;padding:0px;margin-left:230px;">
	...
	<footer class="main-footer">
	   ...
	   <strong>Copyright &copy;2017<a href="#">坤达信息科技有限公司</a>.</strong>保留所有权利。
	</footer>
