...
-->                                
                                ...
                                <tr>
                                    <td>队列排奖:</td>
                                    <td>
                                        是:<input type="radio" <?php if($goodsInfo[is_line_prize] == 1): ?>checked="checked"<?php endif; ?> value="1" name="is_line_prize" /> 
                                        否:<input type="radio" <?php if($goodsInfo[is_line_prize] == 0): ?>checked="checked"<?php endif; ?> value="0" name="is_line_prize" /> 
                                    </td>
                                </tr> 
                                <tr>
                                    <td>分销设置:</td>
                                    <td>
                                        不成为分销商:<input type="radio" <?php if($goodsInfo[distribut_attr] == 0): ?>checked="checked"<?php endif; ?> value="0" name="distribut_attr" /> &nbsp;
                                        分销商一级<input type="radio" <?php if($goodsInfo[distribut_attr] == 1): ?>checked="checked"<?php endif; ?> value="1" name="distribut_attr" />&nbsp;
                                        分销商二级<input type="radio" <?php if($goodsInfo[distribut_attr] == 2): ?>checked="checked"<?php endif; ?> value="2" name="distribut_attr" />&nbsp;
                                        分销商升级<input type="radio" <?php if($goodsInfo[distribut_attr] == 3): ?>checked="checked"<?php endif; ?> value="3" name="distribut_attr" />
                                    </td>
                                </tr>                              
                                <tr>
                                    <td>库存数量:</td>
                                ...
                                <tr>
                                    <td>商品定金:</td>
                                    <td>
                                        <input type="text" class="form-control" style="width:150px;" value="<?php echo ($goodsInfo["deposit_money"]); ?>" name="deposit_money" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                        <span id="err_exchange_integral" style="color:#F00; display:none;"></span>
                                    </td>
                                </tr>
                                <tr>
