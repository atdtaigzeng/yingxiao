                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center">
                                        	<?php
 if($list['is_use']==0){ echo '未使用'; }else{ echo '已使用'; } ?>
                                        </td>
                                        
                                        <td class="text-center">
                                            <a data-url="<?php echo U('Admin/Coupon/deal_coupon_car',array('id'=>$list['id']));?>" onclick="deal(this)" href="javascript:;" data-toggle="tooltip" title="" class="btn btn-info" data-original-title="核销"><i class="fa fa-pencil"></i></a>
                                            <a data-url="<?php echo U('Admin/Coupon/del_coupon_car',array('id'=>$list['id']));?>" onclick="delfun(this)" href="javascript:;" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="删除"><i class="fa fa-trash-o"></i></a>
                                        </td>
