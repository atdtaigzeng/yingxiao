...
<div class="sc_nav">
    <ul>
      <li><a href="<?php echo U('User/collect_list');?>" class="tab_head on" id="goods_ka1" >收藏的宝贝</a></li>
      <li><a href="<?php echo U('User/collect_list');?>" class="tab_head " id="goods_ka2" >收藏的店铺</a></li>
     </ul>
 </div>
-->
...
//			url:"<?php echo U('Mobile/User/collect_list',null,'');?>/is_ajax/1/p/"+page,//+tab,
