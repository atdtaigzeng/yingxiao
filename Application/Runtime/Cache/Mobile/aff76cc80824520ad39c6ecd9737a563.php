...
<form name="cart2_form" id="cart2_form" method="post">
    ...
    <?php if($is_deposit == 1): ?><section class="order-info">
          <div class="order-list">
            <div class="content ptop0">
              <div class="panel panel-default info-box">
                <div class="panel-body" id="buy_div"  >
                  <div class="title" id="buy_title" style="border-bottom:1px solid #eeeeee;"> 
                  	<span class="i-icon-arrow-down i-icon-arrow-up" id="buy_ip"></span>
                    <span class="text">购买方式</span>  
                   	<em class="qxz" id="buy_method_select">请选择购买方式</em> 
                   	
                  </div>
                   <ul class="nav nav-list-sidenav" id="buy_method" style="display:block; border-bottom:none;">
                   
                   		<li class="clearfix" name="payment_name">
	                      <label>
	                      <input type="radio" id="quankuan" name="pay_method"  value="totle"  onclick="ajax_order_price()" class="c_checkbox_t" checked/>
	                      <div class="fl shipping_title"> 全款支付 </div>
	                      </label>
	                    </li>
                   		
	                   <li class="clearfix" name="payment_name">
	                      <label>
	                      <input type="radio" id="dingjing" name="pay_method"  value="<?php echo ($deposit_money); ?>"  onclick="ajax_order_price()" class="c_checkbox_t"/>
	                      <div class="fl shipping_title"> 定金支付(<?php echo ($deposit_money); ?>元) </div>
	                      </label>
	                    </li> 
    ...
    <?php if($is_weight == 1): ?><section class="order-info">
          <div class="order-list">
            <div class="content ptop0">
              <div class="panel panel-default info-box">
                <div class="panel-body" id="pay_div"  >
                  <div class="title" id="zhifutitle" style="border-bottom:1px solid #eeeeee;"> 
                  	<span class="i-icon-arrow-down i-icon-arrow-up" id="zhifuip"></span>
                   	...
                   	<!-- <span class="text">购买方式</span>  
                   	<em class="qxz" id="emzhifu">请选择购买方式</em> -->
   ...
   <section class="order-info">
    <div class="order-list">
      <div class="content ptop0">
        <div class="panel panel-default info-box">
          <div class="orderInfo " >
            <h4 class="seller-name"> <img src="/Template/mobile/new/Static/images/flow/dingdan.png" width="28"> 备注 </h4>
          </div>
          <table border=0 cellpadding=0 cellspacing=0 width="100%" class="checkgoods">
	          <tr>
	              <td colspan=4 class="tdother2" style="border-top:none;"><div class="checkout_other" >
	                  <table id='normal_invoice_tbody_tip' width="100%">
	                      <tr>
	                        <!-- <td align=right style="vertical-align:top" width="84">备注：</td> -->
	                        <td colspan="3">
	                          <input class="txt1" style='vertical-align:middle' type="text" name="tip" placeholder="备注信息" />
	                        </td>
	                      </tr>                      
	                    </table>            
	                </td>
                ...
                <ul class="ct-list order_total_ul" id="ECS_ORDERTOTAL" >
                  ...
                  <li>
                   <div class="subtotal">
                      ...
                      <div class="total-text" style="" id="buy_method_end"></div>  
                   </div>
                  </li>
                </ul>
              </div>
...
function ajax_order_price()
{
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $("#buy_method_end").text(data.result.buy_method); // 购买方式
