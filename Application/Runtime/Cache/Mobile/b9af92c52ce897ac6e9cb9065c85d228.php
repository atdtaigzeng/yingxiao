...
<div class="uer_topnav">
	<ul>
		...
		<li><a href="<?php echo U('Mobile/User/comment');?>"><span><?php echo ($comment_count); ?></span>我的评价</a></li>
            ...
            <div class="Wallet">
                <p style="text-align: center;font-size: 12px;">我的分销商：我发展的<?php echo ($leader); ?>级(<?php echo ($number); ?>)人</p>
            </div>
            <div class="Wallet">
<!--                 搜索
                <div class="endorse_dyr">

                    <form action="/index.php/Mobile/Distribut/lower_list/level/3.html" method="post" id="filter_form">
                        <input class="endor_text" type="text" name="q">
                        <input class="endor_but" type="button" onclick="ajax_search();" value="搜索">
                        <input type="hidden" name="__hash__" value="4bd88547c74807b4ab52970389ab9843_564a54f92b1706844e8910831e115b99">
                    </form>
                </div> -->
                <div class="endorse_dyr bg_gray" id="ajax_return">
                    <?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div class="endorse_num">
                            <div class="hend_endor">
                                <img src='<?php echo ((isset($info[head_pic]) && ($info[head_pic] !== ""))?($info[head_pic]):"/Template/mobile/new/Static/images/user68.jpg"); ?>' width="60" height="60">
                            </div>
                            <div class="sec_endor">
                                <p>昵称：<span><?php echo ($info["nickname"]); ?></span></p>
                                <p>电话：<span><?php echo ($info["mobile"]); ?></span></p>
                                <p>加盟时间：<span><?php echo ($info["reg_time"]); ?></span></p>
                                <p>会员ID：<span><?php echo ($info["user_id"]); ?></span></p>
                            </div>
